...
iface = gr.Interface(
    ...
    outputs=[
        ...
        gr.Textbox(label="Mensagem sobre a Image,"),
    ...
    description="Insira o texto, um número, uma imagem, uma lista de itens, ua cor e opções para ver a entrada processada.",
)
