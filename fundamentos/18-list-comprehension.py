...
moviesWithE = [
  movie for movie in moviesList if 'e' in movie.lower()
]
print(moviesWithE)

# 3 - Mapear filmes que eu assisti
moviesWatched = [
  movie for movie in moviesList if movie != "Jurassic Park"
]
print(moviesWatched)
...
while True:
  ...
  if foundMovies:
    print(f"Filmes(s) encontrado com o nome: {searchName}:")
